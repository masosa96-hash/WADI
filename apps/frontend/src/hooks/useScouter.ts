...
export type AudioContextState = "suspended" | "running" | "closed";
  ...
  return {
    ...
    playAlertSound: useCallback(() => playTone(150, "sawtooth", 0.3), [playTone]), // Check de Lucidez (Error)
    initAmbientHum: useCallback(() => {}, []),
    setAmbientIntensity: useCallback(() => {}, []),
    playDeathSound: useCallback(() => playTone(50, "square", 1), [playTone]),
    playCrystallizeSound: useCallback(() => playTone(1200, "triangle", 0.5), [playTone]), // Success
